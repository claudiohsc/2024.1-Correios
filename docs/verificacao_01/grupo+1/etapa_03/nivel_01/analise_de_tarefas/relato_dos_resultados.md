...
<font size="2"><p style="text-align: center">Tabela 3 - Verificação do relato dos resultados da Análise de Tarefas "Pesquisar procurados".</p></font>
...
| **3** | Apresenta o número e perfil dos avaliadores e participantes da avaliação? | Não | <a href="#ref1">1</a> | [pg 279](../../../../../assets/prints_verificacao/gabrielf/Relato%20dos%20resultados%20ref%20-%20tópicos.jpeg) |
...
- ID 01:  Estão descritos os objetivos da avaliação?
    - Avaliação: Não.
    - Comentário: Os objetivos não foram descritos no artefato. Seria interessante citar para facilitar a avaliação da entrevista.

- ID 02:  Possui uma explicação sobre o método de avaliação usado?
    - Avaliação: Não.
    - Comentário: Não explica qual foi o método utilizado, por mais que seja perceptível pela gravação.

- ID 03: Apresenta o número e perfil dos avaliadores e participantes da avaliação?
    - Avaliação: Não.
    - Comentário: Não apresenta o perfil da pessoa entrevista e nem informações do cronograma realizado.

- ID 05: Faz uma interpretação e análise dos dados?
    - Avaliação: Não.
    - Comentário: Não apresenta uma análise dos dados coletados na entrevista, ficando os dados soltos no documento.
...
| **4** | Possui um sumário dos dados coletados? | Sim | <a href="#ref1">1</a> | [pg 279](../../../../../assets/prints_verificacao/gabrielf/Relato%20dos%20resultados%20ref%20-%20tópicos.jpeg) |
| **5** | Faz uma interpretação e análise dos dados? | Não. | <a href="#ref1">1</a> | [pg 279](../../../../../assets/prints_verificacao/gabrielf/Relato%20dos%20resultados%20ref%20-%20tópicos.jpeg) |
| **6** | Apresenta uma lista dos problemas encontrados? | Não. | <a href="#ref1">1</a> | [pg 279](../../../../../assets/prints_verificacao/gabrielf/Relato%20dos%20resultados%20ref%20-%20tópicos.jpeg) |
...
<font size="2"><p style="text-align: center">Fonte: [Elias F. Oliveira](https://github.com/EliasOlver21), 2024.</p></font>
...
- ID 03: Apresenta o número e perfil dos avaliadores e participantes da avaliação?
    ...
    - Comentário: Somente apresenta o perfil da usuária participante, faltando o perfil da entrevistadora

- ID 05: Faz uma interpretação e análise dos dados?
    - Avaliação: Não
    - Comentário: Os dados são mostrados em uma tabela, mas não é feita nenhuma interpretação ou elucidação sobre eles

- ID 06: Apresenta uma lista dos problemas encontrados?
    - Avaliação: Não
    - Comentário: Não é mostrada nenhuma lista com os problemas encontrados e nenhuma informação de que não foi encontrado nenhum problema
    - 
- ID 07: Possui planejamento para um reprojeto do sistema?
    - Avaliação: Não
    - Comentário: Não foi encontrado nenhuma planejamento para o reprojeto
...
- ID 11: O avaliador explicou para o participante os objetivos do estudo, procedimentos da avaliação e cuidados éticos tomados?
    - Avaliação: Incompleto
    - Comentário: Apenas faltou a avaliadora explicar sobre o objetivo da avaliação feita por ela
...
| ID | Descrição | Avaliação | Referência| Print |
|:--:| --------- | :-------: | :-------: | :---: | 
| **1** | É apresentada uma consolidação dos dados (análise conjunta dos dados individuais)? | não | <a href="#ref1">1</a> | [pg 279](../../../../../assets/prints_verificacao/gabrielf/Relato%20dos%20resultados%20ref%20-%20tópicos.jpeg) |
| **2** | Foram identificadas recorrências na consolidação dos dados? | não se aplica | <a href="#ref1">1</a> | [pg 279](../../../../../assets/prints_verificacao/gabrielf/Relato%20dos%20resultados%20ref%20-%20tópicos.jpeg) |
| **3*** | Todos os participantes receberam as mesmas orientações? | sim | <a href="#ref1">1</a> | [pg 275](../../../../../assets/prints_verificacao/gabrielf/Relato%20dos%20resultados%20ref%20-%20coleta%20dos%20dados%20(informações%20iguais).jpeg) |
...
- ID 1: É apresentada uma consolidação dos dados (análise conjunta dos dados individuais)?
    - Avaliação: não
    - Comentário: não foi apresentada uma consolidação dos dados
